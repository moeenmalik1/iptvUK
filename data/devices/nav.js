// Slim device link list shared by the header (a client component), the footer,
// the RelatedLinks block and the cross-links on each device page. Keeping the
// labels and hrefs here means adding a device updates every menu at once, and
